    ...
    <>
      ...
      <div className="my-5 py-5 text-white">
        <h1 className="font-bold text-center text-[35px]">
          Land in your dream job 🚀 <br /> by proving your skills through
          reclaim protocol{" "}
        </h1>
        <form className="mx-10 px-10 py-5 my-5">
          ...
          <div className="py-10">
            {" "}
            <h3 className="text-center">Lets get to the good part!</h3>
          </div>
          <div className="relative z-0 w-full mb-6 group">
            {/** <input
              type="text"
              name="skills in stacks"
              id="skills"
              className="block py-2.5 px-0 w-full text-sm text-white-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required
            ...
            >
              <option className=" text-blue">Reclaim Protocol</option>
              <option className=" text-blue">NodeJS</option>
              <option className=" text-blue">ReactJS</option>
              <option className=" text-blue">NextJS</option>
              <option className=" text-blue">Solidity</option>
              <option className=" text-blue">TailwindCSS</option>
              <option className=" text-blue">SmartPY</option>
            </select>
            <label
              for="floating_email"
              className="peer-focus:font-medium absolute text-sm text-white dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"

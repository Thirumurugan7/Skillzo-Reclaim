  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="submit"
          className="py-5 lg:py-4 mt-5 transition-colors ease-in bg-yellow px-9 rounded-xl hover:shadow-lg uppercase font-bold text-xl hover:bg-black hover:text-yellow hover:border hover:border-transparent"
        >
          Claim !
        </button>
      </form>
